...
if (fs.existsSync(user_info_file)) {
    ...
    console.log(`${user_info_file} has ${file_stats.size}`);
} else {
...
app.post("/registe_user", function (request, response) {
    ...
    if (request["body"]["password"] != 'undefined') {
        ...
        userdata[username].password = request["body"]["repeat_password"];
    }
    ...
    fs.writeFileSync(user_info_file, JSON.stringify(username));
